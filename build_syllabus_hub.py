...
/* Pill buttons inside day tiles. All dark with white text. Higher specificity beats .day-tile a:not(.btn). */
...
.day-tile a.day-pill.pill-prework:hover,.day-tile a.day-pill.pill-prework:focus-visible,a.day-pill.pill-prework:hover{background:var(--navy-deep);border-color:var(--navy-deep)}
.day-tile a.day-pill.pill-lab,a.day-pill.pill-lab{background:#7D5F2C;border-color:#5C4720}
.day-tile a.day-pill.pill-lab:hover,.day-tile a.day-pill.pill-lab:focus-visible,a.day-pill.pill-lab:hover{background:#5C4720;border-color:#3F3015}
.day-tile a.day-pill.pill-discussion,a.day-pill.pill-discussion{background:var(--terra-dark);border-color:var(--terra-dark)}
.day-tile a.day-pill.pill-discussion:hover,.day-tile a.day-pill.pill-discussion:focus-visible,a.day-pill.pill-discussion:hover{background:#7E3F22;border-color:#7E3F22}
.day-tile a.day-pill.pill-quiz,a.day-pill.pill-quiz{background:#4F6B57;border-color:#3F5B47}
.day-tile a.day-pill.pill-quiz:hover,.day-tile a.day-pill.pill-quiz:focus-visible,a.day-pill.pill-quiz:hover{background:#3F5B47;border-color:#2F4537}
