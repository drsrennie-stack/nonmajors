...
<style>
:root{{--navy:#1E3D4C;--navy-deep:#142A36;--navy-tint:#EDF1F3;--gold:#B8924A;--gold-deep:#9A7838;--terra:#C2734D;--terra-dark:#A0522D;--white:#FFFFFF;--off-white:#FAFAF9;--gray-line:#CFD6DA;--gray-soft:#5C6970}}
...
h2{{font-family:'Plus Jakarta Sans',system-ui,sans-serif;font-weight:600;color:var(--terra-dark);font-size:20px;margin:0 0 10px}}
...
<main id="main" tabindex="-1">
  ...
  <article class="card">
    <h2>2. Structures to label ({structure_count})</h2>
  ...
  <article class="card">
    ...
    <p>Print this workbook. Label every structure by hand. Photograph or scan your finished page and upload to Canvas before the next class. {brief}</p>
  </article>
</main>
